...
public class ComparableExamples {
    public static void main(String[] args) throws InterruptedException {
        ...
        System.out.println();
        Employee e1 = new Employee(111, "Jon", "Teller", 1);
        Employee e2 = new Employee(222, "David", "Braun", 3);
        ...
        if (e1 instanceof Comparable) {
            System.out.println("Yes it's a Comparable!");
        } else {
            System.out.println("No it's not a Comparable!");
        }
