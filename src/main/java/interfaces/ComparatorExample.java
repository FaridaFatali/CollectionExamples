...
public class ComparatorExample {
    ...
    public static void compareExample() {
        Employee e1 = new Employee(111, "Jon", "David", 1);
        Employee e2 = new Employee(222, "Michael", "Braun", 3);
    ...
    public static void collectionExample() {
        ...
        Comparator<Employee> comparator1 = Comparator.comparing(Employee::getLastName);
        ...
        Comparator<Employee> comparator3 = Comparator.comparingInt(Employee::getYear);
