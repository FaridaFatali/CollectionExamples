...
public class NavigableAndSortedSetExample {
    ...
    public static void navigableSetProperties(NavigableSet navigableSet) {
        ...
        System.out.printf("Last   :  %s%n", navigableSet.last());
        System.out.printf("Head set lower than \"i\"  :  %s%n", navigableSet.headSet("i"));
        System.out.printf("Head seat lower than \"i\" including \"i\"  :  %s%n", navigableSet.headSet("i", true));
        System.out.printf("Head seat lower than \"i\" excluding \"i\"  :  %s%n", navigableSet.headSet("i", false));
        ...
        System.out.printf("Least element higher than \"i\"  :  %s%n", navigableSet.headSet("i"));
        System.out.printf("Greatest element lower than \"i\"  :  %s%n", navigableSet.lower("i"));
        System.out.printf("Least element greater than or equal to \"h\"  :  %s%n", navigableSet.ceiling("h"));
