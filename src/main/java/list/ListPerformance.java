...
//Checking work time of ArrayList and LinkedList

public class ListPerformance {
    private static int n = 100_000; // For 100_000 in adding to the front, time for ArrayList is 91923.0 ms & time for LinkedList is 191.0 ms.
...
//        linkedListSearch(n/2);
    ...
    private static void simpleLinkedListAccess() {
        ...
        double end = System.currentTimeMillis();
        System.out.println("Time to access for LinkedList is: " + (end - start));
    }
...
//
//        end = System.currentTimeMillis();
//        System.out.println("Iterating using classical for is: " + (end - start));

        return aList;
    }

    public static LinkedList linkedListInsertion() {
